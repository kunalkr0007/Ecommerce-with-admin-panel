        ...
        <li class="nav-item menu-items">
            ...
            <div class="collapse" id="product">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="{{url('/product/add')}}">Add Product</a>
                    </li>
                    <li class="nav-item"> <a class="nav-link" href="{{url('/product/view')}}">View Product</a></li>
        ...
        <li class="nav-item menu-items">
            ...
            <div class="collapse" id="user">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item"> <a class="nav-link" href="{{url('/user/show')}}">View User</a></li>
